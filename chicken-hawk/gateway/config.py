...
class Settings(BaseSettings):
    ...
    # Lil_Hawk endpoints
    trae_hawk_url: str = Field(..., description="Lil_TRAE_Hawk base URL")
    coding_hawk_url: str = Field(..., description="Lil_Coding_Hawk base URL")
    agent_hawk_url: str = Field(..., description="Lil_Agent_Hawk base URL")
    flow_hawk_url: str = Field(..., description="Lil_Flow_Hawk base URL")
    sand_hawk_url: str = Field(..., description="Lil_Sand_Hawk base URL")
    memory_hawk_url: str = Field(..., description="Lil_Memory_Hawk base URL")
