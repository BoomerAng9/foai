...
window.LEAGUE_DATA = {
  nfl: {
    ...
    rail: [
      { h:'Top Risers', rows:[['1','E. Mcneil-Warren','S',1],['2','D. Ezeiruaku','EDGE',1],['3','B. Thomas Jr.','EDGE',1]] },
      { h:'Top Fallers', accent:'red', rows:[['1','K. Banks Jr.','OT',-1],['2','B. Morrison','CB',-1],['3','L. Basso','LS',-1]] },
      { h:'Team Needs (Top 5)', rows:[['1','LV','QB, WR, OL',0],['2','NYJ','QB, EDGE, WR',0],['3','ARI','QB, OL, EDGE',0],['4','TEN','OL, EDGE, WR',0],['5','NYG','DL, CB, OL',0]] },
      { h:'Transfer Portal Impact', rows:[['1','Caleb Downs','S','Alabama → Ohio State'],['2','Mansoor Delane','CB','Virginia Tech → LSU'],['3','Kadyn Proctor','OT','Iowa → Alabama']] },
      { h:'NIL Market Movers', rows:[['1','Jeremiyah Love','',1],['2','Caleb Downs','',1],['3','Arvell Reese','',1]] },
    ],
    headlines: [
      { kicker:'DRAFT NIGHT', t:'Round 1 Tonight · 32 Picks, 8:00 PM ET', d:'Apr 23, 2026' },
      { kicker:'BIG BOARD',  t:'Love Claims #1 Overall as PRIME Tier Lock', d:'Apr 23, 2026' },
      { kicker:'MOCK DRAFT', t:'Final Per|Form First-Round Projection Published', d:'Apr 22, 2026' },
    ],
    boardH: '2026 NFL DRAFT BIG BOARD',
    board: [
      { rk:1, name:'Jeremiyah Love', pos:'RB',   school:'Notre Dame', chip:'ND',  grade:101.7, tier:'PRIME' },
      { rk:2, name:'Caleb Downs',    pos:'S',    school:'Ohio State', chip:'OSU', grade:91.9,  tier:'A+' },
      { rk:3, name:'Spencer Fano',   pos:'OT',   school:'Utah',       chip:'UTA', grade:91.5,  tier:'A+' },
      { rk:4, name:'Kenyon Sadiq',   pos:'TE',   school:'Oregon',     chip:'ORE', grade:91.5,  tier:'A+' },
      { rk:5, name:'Arvell Reese',   pos:'EDGE', school:'Ohio State', chip:'OSU', grade:90.5,  tier:'A+' },
    ],
    tie: { name:'TIE OUTPUT · #1 OVERALL', grade:101.7, tier:'PRIME', pos:'RB · Notre Dame · Jr.', proj:'Generational · Top 5', nil:'$2.4M', rank:'#1 Overall' },
    tools: [
