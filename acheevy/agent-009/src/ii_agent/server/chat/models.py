...
class ChatMessageRequest(BaseModel):
    ...
    session_snapshot: Optional[SessionSnapshotInfo] = Field(
        None,
        description="Session Snapshot submitted with the current chat request.",
    )
    session_context: Optional[SessionContextInfo] = Field(
        None,
        description="Session Context submitted with the current chat request.",
    )
    build_spec: Optional[BuildSpecInfo] = Field(
        None,
        description="Build Spec submitted with the current chat request.",
    )
    routing_decision: Optional[RoutingDecisionInfo] = Field(
        None,
        description="Routing Decision submitted with the current chat request.",
    )
