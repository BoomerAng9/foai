...
class IIAgentConfig(BaseSettings):
    ...
    elevenlabs_voice_id: str = Field(default="JBFqnCBsd6RMkjVDRZzb")
    ...
    execution_lane_policy: Literal["fallback_to_direct", "fail_closed"] = Field(
        default="fallback_to_direct",
        description="How the runtime handles unsupported non-direct execution lanes.",
    )
