...
import type { SessionSettingsEnvelope } from '@/typings/session-context'
import {
    useAppDispatch,
    useAppSelector,
    setLoading,
...
export type SubmitOptions =
    ...
    | {
        ...
        sessionSettings?: SessionSettingsEnvelope
    }
...
function extractSubmitOptions(value?: SubmitOptions): SubmitOptionsExtracted {
    ...
    return {
        ...
        sessionSettings: value.sessionSettings
    }
}
...
export function useChatTransport(options?: UseChatTransportOptions) {
    ...
    const submitChatQuery = useCallback(
        async (question: string, options?: SubmitOptions): Promise<void> => {
            ...
            const { sessionId, callbacks, sessionSettings } =
            ...
            try {
                ...
                const payload: ChatQueryPayload = {
                    ...
                    session_snapshot: sessionSettings?.session_snapshot,
                    session_context: sessionSettings?.session_context,
                    build_spec: sessionSettings?.build_spec,
                    routing_decision: sessionSettings?.routing_decision
                }
