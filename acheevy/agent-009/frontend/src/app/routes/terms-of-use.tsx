        ...
        <div className="py-8">
            <div className="container mx-auto px-4 max-w-4xl">
                <div className="bg-white dark:bg-[var(--text-brand)]/10 rounded-lg shadow-lg p-8">
                    <h1 className="type-h1 text-gray-900 dark:text-white mb-8">
                        Terms of Use
                    </h1>
                    ...
                    <div className="prose dark:prose-invert max-w-none">
                        ...
                        <section className="mb-8">
                            <h2 className="type-h2 text-gray-900 dark:text-white mb-4">
                                1. Agreement to Terms
                            </h2>
                            <p className="type-body text-gray-700 dark:text-gray-300 mb-4">
