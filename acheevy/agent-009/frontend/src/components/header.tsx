...
const AgentHeader = ({ sessionData, isChatPage }: AgentHeaderProps) => {
    ...
    return (
        <div className="relative flex items-center gap-x-4 border-b border-[var(--border-default)] bg-[rgba(255,255,255,0.62)] px-3 py-3 backdrop-blur-xl md:px-6">
            {isChatPage ? (
                <div className="flex items-center gap-3">
                    <SidebarTrigger className="size-6 p-0" />
                    <div className="hidden md:flex items-center gap-3">
                        <div className="flex size-9 items-center justify-center rounded-[12px] border border-[var(--border-default)] bg-white text-xs font-semibold text-[var(--text-secondary)]">
                            AM
                        </div>
                        <div className="flex flex-col leading-none">
                            <span className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[var(--text-secondary)]">AIMS Workspace</span>
                            <span className="text-sm font-medium text-[var(--text-primary)]">CHAT W/ ACHEEVY</span>
                        </div>
                    </div>
                </div>
            ) : (
            ...
            {sessionData?.name && (
                <div className="flex-1 pr-3 md:pr-0 flex gap-x-4 items-center md:absolute md:left-1/2 md:-translate-x-1/2">
                    <div className="flex-1 flex items-center gap-x-2">
                        ...
                        <span className="font-medium text-sm flex-1 line-clamp-1 text-center text-[var(--text-primary)]">
                            {sessionData?.name}
                        </span>
                    </div>
                    {!isShareMode && (
