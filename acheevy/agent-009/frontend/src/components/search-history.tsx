        ...
        <Sheet open={open} onOpenChange={setOpen}>
            ...
            >
                <SheetHeader className="p-0 gap-6 md:pb-6">
                    ...
                    <Button
                        className="h-12 w-full rounded-[12px] border border-[var(--border-default)] bg-white font-semibold !text-[var(--text-primary)] shadow-none hover:bg-[#f3f1ed]"
                        onClick={handleNewChat}
                    >
                        <Icon
                            name="edit"
                            className="size-6 fill-[var(--text-primary)]"
                        />
                        New Chat
                    </Button>
                </SheetHeader>
                                ...
                                <div className="space-y-3 mt-3">
                                    {value.map((session) => (
                                        <Link
                                            ...
                                            className={cn(
                                                'line-clamp-1 flex items-center gap-x-2 rounded-[10px] px-2 py-1.5 text-sm text-[var(--text-secondary)] hover:bg-[#f3f1ed] hover:text-[var(--text-primary)] md:text-base'
                                            )}
                                        >
                                            {session.name}
                                        </Link>
