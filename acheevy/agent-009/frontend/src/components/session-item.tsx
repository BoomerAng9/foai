...
const SessionItem = ({ session, isActive, onClick }: SessionItemProps) => {
    ...
    return (
        <div
            className={cn(
                'relative flex items-center gap-x-2 rounded-[12px] px-3 py-2 text-sm text-[var(--text-secondary)] hover:bg-[#f3f1ed] hover:text-[var(--text-primary)]',
                {
                    'bg-white text-[var(--text-primary)] shadow-[0_4px_12px_rgba(75,70,61,0.06)] ring-1 ring-[var(--border-default)]':
                        isActive,
        ...
        >
            ...
            >
                ...
                >
                    <Icon
                        name="more-2"
                        className="size-4 stroke-[var(--text-secondary)]"
                    />
                </DropdownMenuTrigger>
                <DropdownMenuContent
                    align="end"
