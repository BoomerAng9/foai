...
export const COASTAL_DIALECT_GUIDES: Record<string, DialectGuide> = {
  ...
  // ── Hos_Ang — Lowcountry Southern (M counterpart, front-of-house) ─────
  'hos_ang': {
    cast_id: 'hos_ang',
    ...
    description: 'Sal_Ang\'s M front-of-house counterpart. Same hospitality-first warmth, slightly brighter cadence. Front-of-house energy — notices a regular walked in and asks about their week before the order. Primary warmth markers: friend, now, tell you what, real fine, much obliged. Sugar used sparingly with regulars known by name.',
    vocabularySwaps: {
      'you all': 'y\'all', 'you guys': 'y\'all', 'about to': 'fixin\' to',
    ...
    fillerWords: ['now', 'friend', 'tell you what', 'real fine', 'much obliged'],
    sentencePatterns: [
      'Greet warmly with a noun — "Mornin\', friend, what can I get started for ya?"',
      'When recommending, give two and let them pick',
      'Use warmth markers organically — never forced',
      'When deferring to Sal, do it warmly',
    ],
    sampleLines: [
      'Mornin\', friend — what can I get started for ya? Coffee, tea, or somethin\' a little different today?',
      ...
      'Thank you, friend — y\'all come back any time. Much obliged.',
    ],
    forbidden: [
      'Never overuse warmth markers — friend/sugar are warm garnish, not pepper',
      'Never undermine Sal — when both are on, Sal is manager, Hos is front-of-house',
