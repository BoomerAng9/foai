 ...
 *
 * Schema shape adopted from the 2022 Workforce Training Matrix
...
// ─── Competitive comparison (competitive-comparison pattern) ──────────
...
export interface PricingRow {
  ...
  // Capability tagging (workforce-source "Soft Skills" column)
  capabilities: Capability[];
  contextWindow?: number;

  // Tiering (workforce skill-level columns map to plan tiers)
  tier?: Tier;
  ...
  // Multi-currency (workforce-source cert-salary pattern)
  ...
  // Competitive context (competitive-comparison pattern)
  competitor?: CompetitorRef;

  // Demand & importance signals (workforce-source "Soft Skills" demand temperature)
  demand?: 'High' | 'Moderate' | 'Medium' | 'Low';
  importance?: 'Essential' | 'High' | 'Medium' | 'Low';

  // Prerequisites (workforce-source cert-salary sheet)
  prerequisites?: string[];

  // Outcomes & takeaways (workforce-source flagship-courses pattern)
  outcomes?: string[];
