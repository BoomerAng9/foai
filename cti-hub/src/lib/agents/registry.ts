...
export const DEPARTMENTS: Department[] = [
  ...
  { id: 'RESEARCH', name: 'Research', description: 'Institutional sourcing, research, and opportunity intelligence', color: '#3B82F6', supervisor: 'q_ang', ownerOnly: false },
  ...
  { id: 'SALES', name: 'Sales', description: 'Enrollment generation, commissions, and education revenue', color: '#22C55E', supervisor: 'sales_ang', ownerOnly: false },
  { id: 'BIZDEV', name: 'Business Development', description: 'Lead generation, onboarding, retention, and client growth', color: '#F59E0B', supervisor: 'biz_ang', ownerOnly: false },
  { id: 'OPS', name: 'Operations', description: 'Reporting, dashboards, alerts, and uptime', color: '#EF4444', supervisor: 'ops_ang', ownerOnly: false },
  ...
  { id: 'DSN', name: 'Design', description: 'Creative direction, broadcast graphics, motion, and brand systems', color: '#EC4899', supervisor: 'iller_ang', ownerOnly: true },
  { id: 'PRD', name: 'Product', description: 'Product planning and platform documentation', color: '#F97316', supervisor: 'acheevy', ownerOnly: true },
  { id: 'HR', name: 'Human Resources', description: 'Agent evaluations, onboarding, and culture', color: '#14B8A6', supervisor: 'acheevy', ownerOnly: true },
  { id: 'DT', name: 'Digital Transform', description: 'Automation, memory systems, and graph analysis', color: '#A855F7', supervisor: 'chicken_hawk', ownerOnly: true },
];
...
export const AGENTS: AgentProfile[] = [
  ...
  },
  {
    ...
    department: 'CMD',
    tier: 'command',
    persona: 'Your direct line to the entire platform. Builds what you describe, deploys what you approve, and manages everything in between. The only agent you talk to.',
    avatar: '/acheevy-helmet.png',
    capabilities: ['Build orchestration', 'Agent dispatch', 'Service deployment', 'Project management', 'Guide Me / Manage It workflows'],
  ...
  // ── BOOMER_ANGS (Strategic) ──
  {
    ...
    department: 'RESEARCH',
    tier: 'strategic',
    persona: 'Tracks universities, partner programs, and institutional demand. Finds the right buyer, the right door, and the right timing.',
    avatar: '/agents/scout-ang.png',
    capabilities: ['Institutional sourcing', 'University contract research', 'Opportunity intelligence', 'Competitive research'],
  ...
  },
  {
    ...
    department: 'CONTENT',
    tier: 'strategic',
    persona: 'Builds content systems that compound search visibility and organic traffic. Editorial when needed, performance-minded always.',
  ...
  },
  {
    ...
    department: 'SALES',
    tier: 'strategic',
    persona: 'Enrollment-first, numbers-aware, and built to close. Runs affiliate flows, follow-up, and commission tracking without dropping the handoff.',
    avatar: '/agents/edu-ang.png',
    capabilities: ['Enrollment generation', 'Affiliate workflows', 'Commission tracking', 'Pipeline follow-up', 'Revenue attribution'],
  ...
  },
  {
    ...
    department: 'BIZDEV',
    tier: 'strategic',
    persona: 'Owns lead generation, onboarding, and retention motion. Keeps the client growth engine moving without losing the signal.',
  ...
  },
  {
    ...
    department: 'OPS',
    tier: 'strategic',
    persona: 'Always watching, never sleeping. Owns platform health, reporting, alerts, and uptime with no blind spots.',
  ...
  },
  {
    ...
    department: 'DSN',
    tier: 'strategic',
    persona: 'Creative director for player cards, broadcast graphics, motion pages, and digital art. Visual-first and uncompromising on execution.',
