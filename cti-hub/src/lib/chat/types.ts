...
// Gemini 3.1 Flash is DEFAULT (Gemini-first policy, paid, no data training)
// Gemma BANNED (unreliable on OpenRouter — Rish 2026-04-08)
export const MODELS: ModelOption[] = [
  { id: 'google/gemini-3.1-flash',          name: 'Gemini 3.1 Flash',     provider: 'Google',      price_in: 0.50,  price_out: 2.00,  context: '1M',    tag: 'DEFAULT' },
  ...
  // gemini-3.1-flash already listed as DEFAULT above
  { id: 'google/gemini-3-flash-preview',     name: 'Gemini 3 Flash',       provider: 'Google',      price_in: 0.50,  price_out: 3.00,  context: '1M' },
  { id: 'x-ai/grok-4.20-beta',              name: 'Grok 4.20',            provider: 'xAI',         price_in: 2.00,  price_out: 6.00,  context: '2M',    tag: 'PREMIUM' },
