        ...
        <div className="max-w-5xl mx-auto section-line">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              ...
              <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', lineHeight: 1.6 }}>
                Meet the Boomer_Angs — 12 executive AI agents across research, creative, engineering, business, education, finance, video production, audio, editing, distribution, publishing, and marketing. They plan before they act and remember what worked.
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { name: 'LUC', role: 'Cost Analyst', desc: 'Every token counted, every dollar tracked. LUC manages budgets, quotes costs, and ensures financial transparency.', back: 'LUC appears whenever there\'s a cost decision. Precise, transparent, fair. Powers the Finance Analyst plug and Broad|Cast cost estimates.' },
              { name: 'Beat_Ang', role: 'Audio & Music', desc: 'Audio production specialist in Broad|Cast Studio. Sound design, music selection, and audio mixing for video content.', back: 'Beat_Ang handles the audio layer — background music, sound effects, voiceover mixing, and audio-reactive visuals for broadcast content.' },
              { name: 'CUT_Ang', role: 'Video Editing', desc: 'Timeline specialist in Broad|Cast Studio. Cuts, transitions, pacing, and visual flow for professional video output.', back: 'CUT_Ang manages the editorial process — shot selection, transition timing, pacing adjustments, and final cut quality assurance.' },
              { name: 'Social_Ang', role: 'Social Distribution', desc: 'Handles platform-specific formatting and distribution. TikTok, Reels, YouTube Shorts — each format optimized.', back: 'Social_Ang knows each platform\'s algorithm preferences, aspect ratios, caption styles, and posting schedules. Content goes where it performs best.' },
              { name: 'Publish_Ang', role: 'Publishing & CDN', desc: 'Gets your content live. YouTube upload, CDN delivery, RSS feeds for podcasts, embed codes for websites.', back: 'Publish_Ang manages the last mile — rendering, uploading, generating shareable links, and ensuring your content reaches its audience.' },
              { name: 'PROMO_Ang', role: 'Marketing & Promo', desc: 'Creates promotional materials for your content. Thumbnails, social cards, ad copy, and campaign strategies.', back: 'PROMO_Ang generates thumbnails, writes ad copy, plans promotional campaigns, and tracks engagement metrics across platforms.' },
            ].map((agent) => (
              <div
                key={agent.name}
