        ...
        <div className="max-w-5xl mx-auto section-line">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <Brain className="w-7 h-7 tile-icon" style={{ transition: 'all 0.35s ease' }} />, title: 'Grammar (NTNTN)', accent: 'The Intention Engine', desc: 'Say what you mean, even if you\'re not technical. Grammar translates your plain English into precise instructions the platform can act on. No jargon. No spec documents.' },
