  ...
  return (
    ...
    >
      ...
      <ul className="ml-5 list-disc space-y-2">
        <li><strong className="text-foreground">Roast &amp; pack:</strong> 2 to 5 business days from the moment your payment clears. Each order is a 100% custom run — labels print on demand and coffee is batched and roasted every business day.</li>
      ...
      <p><strong className="text-foreground">Total order-to-doorstep time: averages 5 business days non-holiday, can run 4 to 10 during peak season.</strong></p>
      ...
      <p>We ship internationally where available, with the route picked by package weight:</p>
      <ul className="ml-5 list-disc space-y-2">
        <li><strong className="text-foreground">0 to 3 lbs:</strong> USPS First-Class International.</li>
        <li><strong className="text-foreground">3+ lbs:</strong> USPS Priority International.</li>
      ...
      <p>Bulk orders ship <strong className="text-foreground">Ex-Warehouse</strong> — once the carrier picks up the pallet from us, the order is yours and the responsibility for transit transfers to you. Insurance is your call.</p>
      <p>Bulk minimums per SKU:</p>
      <ul className="ml-5 list-disc space-y-1">
        <li>12oz bags: 12 per SKU</li>
        <li>1 lb bags: 12 per SKU</li>
        <li>2 lb bags: 6 per SKU</li>
        <li>5 lb bags: 1 per SKU (no minimum)</li>
        <li>2 oz sample bags: 12 per SKU</li>
      </ul>
