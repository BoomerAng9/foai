...
# Owner directive 2026-05-11 — Mercury public API has no invoicing surface
# (confirmed via 404s on /invoicing/* with valid token), reverting to Stripe
# Checkout for the 4 /pricing subscription SKUs. Mercury stays as the
# destination bank where Stripe payouts land. Line-item logic + intent-id
# remain processor-agnostic in `membership_subscribe.py`.
